...
function bhn_scripts() {
	...
	wp_enqueue_script( 'bhn-script', get_stylesheet_directory_uri() . '/assets/js/functions-min.js', array( 'jquery-slim' ), filemtime( get_stylesheet_directory().'/assets/js/functions.js' ), true );
}
